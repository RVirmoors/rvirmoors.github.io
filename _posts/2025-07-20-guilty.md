...
Content warning: the following might be seen as extremely cringeworthy. 
...
So what is this great menace I've entangled myself in, you ask. It's a very dull thing really, which however gets very exciting and addictive once you fall for it: online trading.[^1]
...
- I'm a lazy bastard, I look for big rewards for minimal effort -- and I will also spend days upon weeks working on something if I convince myself it will save me time/effort in the long run.
...
3. decisions. Who actually makes all the right decisions, right on time? There are a few "elite" traders who get super good at this after years of practice, but I'll never be one of them. So if we agree that mistakes are inevitable, why not trade them off for the regular imperfections of the algorithm.
...
So, when you look at the armies of retail traders deciding to trade manually, it boils down to:
...
OK, so here are the two strategies I've implemented. They're taken from the traders mentioned above (and the many whom they've influenced), and validated by seeing them in action on countless charts and through backtesting on my dataset.

The Qullamaggie-inspired *breakout* looks like this. Here's a *setup*, you're supposed to buy on the next day (after the right edge of the screenshot) if prices go higher:
